		...
		<div class="container">
			<div class="row">
				<div class="col-md-12 col-lg-12">
					<h1 class="page-header"><?php print $tempnm; ?> - <?php print $rollno; ?> Achivements Report</h1>  
				</div>
			</div>
			<div class="row">
			<div class="col-md-12 col-lg-12">
			<?php
				if ($_POST['student'] === 'y' && isset($_POST['rollno'])) {
				 ...
				 $sq= "SELECT DISTINCT date FROM Achivements ORDER BY date";
				...
				echo "<table class='table table-striped table-hover reports-table'>";
				 ...
				 $stmt3->execute();
					...
					$stmt4->execute();
						...
						for($i=0;$i<count($result2);$i++)
						 {
							...
							$sql1= "SELECT ispresent FROM Achivements where sid=$tempid AND id=$subid AND date=$tmdat ORDER BY date";
						...
						$dttaken++;
						 if (empty($result1)) {
								echo " <td><span class='badge' style='background-color:#d44845;'>Not Won</span></td>";
								$nottaken++;
								$dnottaken++;
						 }else
						 {
							...
							if($res==1)
							{
								echo " <td><span class='badge' style='background-color:#3C923C;'>Winner</span></td>";
								$present++;
								$dpresent++;	
							}
								else
                ...
                <div class="panel-heading">
                  <h3 class="panel-title">Summary Of Achivements</h3>
                </div>
                <div class="panel-body">
                  <p>Total achivements won:&nbsp;<strong>' . $present . '/' . $tlec . '</strong></p>
									<p>Achivements Percentage:&nbsp;<strong>' .$tper. '&nbsp;%</strong></p>
                </div>
              </div>';
